...
print("---------")
#pe ce pozitii se afla spatiile intr un sir de caractere
sir="Azi este o zi frumoasa"
for pozitie in range(len(sir)):
    if sir[pozitie]=="":   #pozitie e indexul curent; sir[pozitie] ....
        print("spatiu gasit pe pozitia:",pozitie)
#while - parcurgere cu nr necunoscut de pasi

#afisam caracterele din sir pana intalnim un spatiu
sir="Azi este o zi frumoasa"
i=0
while sir[i] !="": #cat timp valoarea de la pozitie i nu e spatiu
    print(sir[i])
    i +=1  #i = i+1
